...
if(isset($_POST['id'])){
    ...
    if(!empty($_FILES['img']['name'])){
        ...
        $sql = "Select image from jeepsafari where id='$id'";
        ...
        $sql2 = "UPDATE jeepsafari SET name='$name',description='$desc',image='$location' WHERE id=$id";
        ...
        $sql = "UPDATE jeepsafari SET name='$name',description='$desc',image='$image' WHERE id='$id'";
